...
function modeSwitch() {
  ...
  // section title
  sectionTitle.classList.toggle("dark");
  sectionTitle.classList.toggle("light");

  // email subsection
  emailSub.classList.toggle("dark");
  emailSub.classList.toggle("light");

  // topic card
  topicCard.classList.toggle("dark");
  topicCard.classList.toggle("light");
}
